...
- Sprint 2: 친구 시스템, DM, 방 시스템, GameBehaviour 모듈러 인터페이스
- Sprint 3: 7게임 (Tetris, Bomberman, Skribbl, Snake.io, 2048, Minesweeper, Pac-Man)
- Sprint 4: 영구 기록, Broadway Mongo 큐, 사내 서버 배포 + HTTPS
